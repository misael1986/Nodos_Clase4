...
public class Pila {
    ...
    // Nodo puntero que indica el inicio de la pila o tambein conocida como el
    // tope de la pila.
    private Nodo inicio;
    ...
    /**
     * Constructor de la pila inicial.
     */
    public void Pila(){
        this.inicio = null;
        this.tamanio = 0;
     ...
     */  
    public void remover(int buscado){
     ...
     */
    public void editar(int buscado, int nuevoValor){
    ...
    /**
     * Elimina la pila entera (borrar todo)
     */
